...
import { Award, Recycle, Trash2, Calendar } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-background pb-24 pt-6 px-4 animate-fade-in">
      ...
      <header className="mb-6">
        <h1 className="text-2xl font-bold text-foreground">Points Dashboard</h1>
        <p className="text-muted-foreground">Track your eco-contributions</p>
      </header>
