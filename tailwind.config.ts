  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        "general-waste": {
          DEFAULT: "hsl(var(--general-waste))",
          bg: "hsl(var(--general-waste-bg))",
        },
        points: {
          gold: "hsl(var(--points-gold))",
          "gold-bg": "hsl(var(--points-gold-bg))",
        },
        sidebar: {
      ...
      boxShadow: {
        "eco": "0 4px 20px -2px hsl(var(--eco-green) / 0.2)",
        "eco-lg": "0 8px 30px -4px hsl(var(--eco-green) / 0.25)",
